...
func (r ApiGetWebhookSecretKeyRequest) Execute() (*WebhookSecretKey, *http.Response, error) {
	return r.ApiService.GetWebhookSecretKeyExecute(r)
}
...
func (a *WebhookSecretKeyAPIService) GetWebhookSecretKeyExecute(r ApiGetWebhookSecretKeyRequest) (*WebhookSecretKey, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *WebhookSecretKey
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WebhookSecretKeyAPIService.GetWebhookSecretKey")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/organizations/{organization_name}/webhook-secret-key"
...
func (r ApiUpdateWebhookSecretKeyRequest) Execute() (*WebhookSecretKey, *http.Response, error) {
	return r.ApiService.UpdateWebhookSecretKeyExecute(r)
}
...
// Execute executes the request
//  @return WebhookSecretKey
func (a *WebhookSecretKeyAPIService) UpdateWebhookSecretKeyExecute(r ApiUpdateWebhookSecretKeyRequest) (*WebhookSecretKey, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WebhookSecretKeyAPIService.UpdateWebhookSecretKey")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
