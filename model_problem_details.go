...
type ProblemDetails struct {
	...
	Type *string `json:"type,omitempty" validate:"regexp=^(?:[a-zA-Z][a-zA-Z0-9+.-]*:)?(?:\\/{0,2}[^\\\\s\\/?#]+)?(?:\\/[^\\\\s?#]*)?(?:\\\\?[^\\\\s#]*)?(?:#\\\\S*)?$"`
	...
	Instance *string `json:"instance,omitempty" validate:"regexp=^(?:[a-zA-Z][a-zA-Z0-9+.-]*:)?(?:\\/{0,2}[^\\\\s\\/?#]+)?(?:\\/[^\\\\s?#]*)?(?:\\\\?[^\\\\s#]*)?(?:#\\\\S*)?$"`
}
